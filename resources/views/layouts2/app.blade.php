...
<script src="{{ asset('') }}landing/assets/libs/apexcharts/dist/apexcharts.min.js"></script>
<script src="{{ asset('') }}landing/assets/js/dashboards/dashboard2.js"></script>
<script src="{{ asset('') }}landing/assets/libs/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="{{ asset('') }}landing/assets/js/datatable/datatable-basic.init.js"></script>
</body>
{{-- <script>
