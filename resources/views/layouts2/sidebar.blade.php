<aside class="left-sidebar with-vertical">
    <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="/landing-page" class="text-nowrap logo-img">
          <img src="{{ asset('') }}landing/assets/images/logos/logo-light.svg" class="dark-logo" alt="Logo-Dark" />
          <img src="{{ asset('') }}landing/assets/images/logos/logo-dark.svg" class="light-logo" alt="Logo-light" />
        </a>
  ...
  <div class="card-body p-4">
    <div class="d-flex align-items-center justify-content-between gap-3">
      <div class="d-flex align-items-center gap-3">
        <img src="{{ asset('') }}landing/assets/images/profile/user-1.jpg" width="45" height="45" class="img-fluid rounded-circle" alt="" />
        <div>
