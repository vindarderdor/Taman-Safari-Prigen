            ...
            >
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                ...
                @if (auth()->user()->ID_JENIS_USER == $menu->ID_JENIS_USER)
                    @php
                        // Filter submenus yang cocok dengan parent_id dari menu
                        $filteredSubmenus = $submenus->filter(function($submenu) use ($menu) {
                            return $submenu->LEVEL == $menu->PARENT_ID;
                        });
                    @endphp
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="position-relative p-4 border-start h-100">
                                            <h5 class="fs-5 mb-7 fw-semibold">{{ $menu->MENU_NAME }}</h5>
                    ...
                    >
                      ...
                      <div class="deshboard-templete-content p-3">
                        <a href="../main/index.html" target="_blank">
                          <h6 class="mb-1 fs-4">{{ $buku->judul }}</h6>
                        </a>
